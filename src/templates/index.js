      ...
      <Layout>
        ...
        {/* <!-- Wrapper --> */}
                    ...
                    <div className="container">
                      ...
                      <section>
                        ...
                        <p>
                          ...
                          This is <u>underlined</u> and this is code: <code>for while</code>. Finally, <a href="/">this is a link</a>.
                        </p>
                        <hr />
                        <header>
                        ...
                        <hr />
                        <h5>Blockquote</h5>
                        <blockquote>Fringilla nisl. Donec accumsan interdum nisi, quis tincidunt felis sagittis eget tempus euismod. Vestibulum ante ipsums volutpat ac adipiscing accumsan faucibus. Vestibulum ante ipsum primis in faucibus lorem ipsum dolor sit amet nullam adipiscing eu felis.</blockquote>
                        <h5>Preformatted</h5>
          ...
          <div id="titleBar" onClick={this.toggleMenu}>
            ...
            <span className="title">Fresh Prince</span>
          </div>
      </Layout>
    )
  }
